...
function finishQuiz() {
  ...
  if(playerData.goodAnswers == 1 || playerData.goodAnswers == 2){
    ...
    resultBox.innerHTML +="<img src=\"https://cdn.discordapp.com/attachments/780422159972827177/796700836608081931/Jim_van_der_Want_Folkert_de_Jong.jpg\" width=\"250px\" height=\"150px\">";
  }
    else if(playerData.goodAnswers == 3 || playerData.goodAnswers == 4){
    resultBox.innerHTML = "<h2>Gefeliciteerd <br>U bent: </br></h2>"
    resultBox.innerHTML +="<img src=\"https://cdn.discordapp.com/attachments/780422159972827177/796700827939110922/9CE526DB-B762-4886-B3A4-CE7735FB4FD4.JPG\" width=\"250px\" height=\"350px\">";
  }
      else{
      resultBox.innerHTML = "<h2>Gefeliciteerd <br>U bent: </br></h2>"
      resultBox.innerHTML +="<img src=\"https://cdn.discordapp.com/attachments/780422159972827177/796700827565162516/Folkert_de_Jong_portret.jpg\" width=\"250\" height=\"150\">";
  }
